...
A antítese de Zero Trust é justamente o modelo de perímetro: uma vez dentro da rede confiável (VPN, firewall corporativo), pouca ou nenhuma verificação adicional acontece. Mais simples de montar, mas uma única credencial vazada ou um único ponto de entrada comprometido dá acesso a tudo que está "dentro".
